...
+ **Spring Security**
  ...
  + [스프링시큐리티 동작 구조]([https://blog.naver.com/ghdalswl77/222517833354](https://blog.naver.com/ghdalswl77/222498106263), "link")
+ JWT
...
| 상품검색 | GET | /product/search | 상품 검색. 가격대, 배송타입, 이미지만 보기 등 정렬 검색 기능. 상품명, 판매자, 상품 사진 등 정보 포함. [검색 기능 구현](https://blog.naver.com/ghdalswl77/222661721733), "link") | ☑️ |
